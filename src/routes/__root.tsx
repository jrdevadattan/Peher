...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "PEHER â€” Extra is our love language." },
      { name: "description", content: "PEHER by Vasudha Tiwari. Handcrafted luxury jewellery â€” timeless pieces shaped by emotion." },
      { name: "author", content: "PEHER" },
      { property: "og:title", content: "PEHER â€” Extra is our love language." },
