        ...
        <div className="lg:col-span-5">
          ...
          <div className="mt-12 border-t border-black/10">
            {[
              ...
              { t: "Shipping", c: "We currently ship across India. Orders are processed within 1–3 business days after confirmation. Standard delivery usually takes 7–8 business days depending on your location. Cash on Delivery (COD) is not available — we accept prepaid orders only. Standard shipping charge is ₹99 per order. Free shipping is available on orders above ₹1,500. Delivery timelines may vary during festivals, sales, or due to unforeseen courier delays." },
